...
export default function CustomerLoyalty({ 
  ...
  return (
    <div id="loyalty-passport-center" className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-6 bg-[#1a1513] p-6 rounded-2xl border border-[#2c221e] flex flex-col justify-between min-h-[400px]">
        <div>
          ...
          {stampsArray.map((isStamped, idx) => (
            <div 
              ...
              className={`h-14 rounded-xl border flex flex-col items-center justify-center relative transition-all duration-300 ${
                isStamped 
                  ? "bg-[#c89d7c]/20 border-[#c89d7c] text-white shadow-lg shadow-[#c89d7c]/10 scale-102" 
                  : "bg-[#120f0e] border-[#251f1c] text-stone-700"
              }`}
            >
              <Coffee size={20} className={isStamped ? "text-[#c89d7c] animate-pulse" : "text-stone-800"} />
              <span className="text-[9px] font-mono mt-1 font-bold">{idx + 1}</span>
              {isStamped && (
                <span className="absolute top-1 right-1 text-[8px] bg-[#c89d7c] text-[#120f0e] font-black rounded-full h-3 w-3 flex items-center justify-center">✓</span>
              )}
            </div>
          ))}
        </div>
        ...
        <button
          ...
          className="w-full bg-[#c89d7c] hover:bg-[#b08766] disabled:bg-stone-800 disabled:text-stone-500 text-[#120f0e] font-black py-3 px-4 rounded-xl text-xs transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-amber-950/25"
        >
      ...
      <div className="lg:col-span-6 bg-[#1a1513] p-6 rounded-2xl border border-[#2c221e] flex flex-col justify-between min-h-[400px]">
            ...
            return (
              <div 
                ...
                className={`flex flex-col items-center justify-center p-3 rounded-full h-20 w-20 border text-center transition-all ${
                  hasStamp
                    ? "bg-[#181412] border-[#c89d7c] rotate-3 shadow-lg shadow-amber-950/40 scale-105"
                    : "bg-[#120f0e]/50 border-[#221c1a] opacity-40"
                }`}
              >
                ...
                {hasStamp ? (
                  <span className="text-[8px] font-mono text-[#c89d7c] mt-0.5 font-bold">STAMPED ✓</span>
                ) : (
        ...
        <div className="bg-[#120f0e] p-3 rounded-xl border border-[#251e1b] text-center text-xs">
      ...
      <div className="lg:col-span-12 bg-[#120f0e] rounded-2xl p-6 border border-[#2c221e] mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-[#1a1513] p-4 rounded-xl border border-[#241d1a] flex flex-col justify-between">
            <div>
              <span className="text-[10px] font-mono text-[#c89d7c] bg-[#c89d7c]/10 border border-[#c89d7c]/20 px-2 py-0.5 rounded">VOUCHER</span>
            ...
            <div className="flex justify-between items-center mt-4 pt-3 border-t border-[#251e1b]">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-[#c89d7c]/20 border border-[#c89d7c] hover:bg-[#c89d7c] hover:text-black text-xs text-[#c89d7c] font-bold transition-all"
              >
                Exchange
              </button>
            </div>
          ...
          <div className="bg-[#1a1513] p-4 rounded-xl border border-[#241d1a] flex flex-col justify-between">
            <div>
              <span className="text-[10px] font-mono text-[#c89d7c] bg-[#c89d7c]/10 border border-[#c89d7c]/20 px-2 py-0.5 rounded">SPECIALTY upgrade</span>
          ...
          <div className="bg-[#1a1513] p-4 rounded-xl border border-[#241d1a] flex flex-col justify-between">
            <div>
              <span className="text-[10px] font-mono text-[#c89d7c] bg-[#c89d7c]/10 border border-[#c89d7c]/20 px-2 py-0.5 rounded">EXCLUSIVE PACKAGE</span>
